...
struct SongListFilterView: View {
    ...
    var versionOptions: [String] { user.currentMode == 0 ? user.chunithm.custom.versionList : user.maimai.custom.versionList }
    var levelOptions: [String] = ["1", "2", "3", "4", "5", "6", "7", "7+", "8", "8+", "9", "9+", "10", "10+", "11", "11+", "12", "12+", "13", "13+", "14", "14+", "15"]
    var genreOptions: [String] { user.currentMode == 0 ? user.chunithm.custom.genreList : user.maimai.custom.genreList }
